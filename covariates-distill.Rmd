...
```{r basic, fig.cap="Distribution of radial distances of amakihi"}
...
```{r box, fig.show='hold', fig.cap="Visual assessment of effect of observer and hour since sunrise upon detection."}
...
```{r, scatter, fig.cap="Visualisation of detectability as function of minutes since sunrise."}
...
```{r bestmod, fig.cap="PDF of best fitting model, including effects of observer and minutes after sunrise."}
